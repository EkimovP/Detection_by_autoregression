...
// IT2.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CIT2App, CWinApp)
...
// Единственный объект CIT2App

CIT2App theApp;


// Инициализация CIT2App

BOOL CIT2App::InitInstance()
{
